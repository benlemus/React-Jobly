...
\restrict tSSOv7tGWlZOfpWYddCM7JKEKOuqArSBtqgsBXe66JNRQBCLNy5auzJ5hp1H5MT
...
--
-- Name: applications; Type: TABLE; Schema: public; Owner: blem
--
...
ALTER TABLE public.applications OWNER TO blem;

--
-- Name: companies; Type: TABLE; Schema: public; Owner: blem
--
...
ALTER TABLE public.companies OWNER TO blem;

--
-- Name: jobs; Type: TABLE; Schema: public; Owner: blem
--
...
ALTER TABLE public.jobs OWNER TO blem;

--
-- Name: jobs_id_seq; Type: SEQUENCE; Schema: public; Owner: blem
--
...
ALTER TABLE public.jobs_id_seq OWNER TO blem;

--
-- Name: jobs_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: blem
--
...
--
-- Name: users; Type: TABLE; Schema: public; Owner: blem
--
...
ALTER TABLE public.users OWNER TO blem;

--
-- Name: jobs id; Type: DEFAULT; Schema: public; Owner: blem
--
...
--
-- Data for Name: applications; Type: TABLE DATA; Schema: public; Owner: blem
--
...
--
-- Data for Name: companies; Type: TABLE DATA; Schema: public; Owner: blem
--
...
--
-- Data for Name: jobs; Type: TABLE DATA; Schema: public; Owner: blem
--
...
--
-- Data for Name: users; Type: TABLE DATA; Schema: public; Owner: blem
--
...
blem	$2b$12$G.0qydEieNR9YgWPN8j7quNLpaaLPERD1P.glBQf1CLwJqvCzr1aK	ben	lemus	ben@gmail.com	f
\.


--
-- Name: jobs_id_seq; Type: SEQUENCE SET; Schema: public; Owner: blem
--
...
--
-- Name: applications applications_pkey; Type: CONSTRAINT; Schema: public; Owner: blem
--
...
--
-- Name: companies companies_name_key; Type: CONSTRAINT; Schema: public; Owner: blem
--
...
--
-- Name: companies companies_pkey; Type: CONSTRAINT; Schema: public; Owner: blem
--
...
--
-- Name: jobs jobs_pkey; Type: CONSTRAINT; Schema: public; Owner: blem
--
...
--
-- Name: users users_pkey; Type: CONSTRAINT; Schema: public; Owner: blem
--
...
--
-- Name: applications applications_job_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: blem
--
...
--
-- Name: applications applications_username_fkey; Type: FK CONSTRAINT; Schema: public; Owner: blem
--
...
--
-- Name: jobs jobs_company_handle_fkey; Type: FK CONSTRAINT; Schema: public; Owner: blem
--
...
\unrestrict tSSOv7tGWlZOfpWYddCM7JKEKOuqArSBtqgsBXe66JNRQBCLNy5auzJ5hp1H5MT
